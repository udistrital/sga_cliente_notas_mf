export const environment = {
  ...
  //SGA_MID_NOTAS_SERVICE: 'http://localhost:8095/v1/',
  SGA_MID_NOTAS_SERVICE:
    "http://pruebasapi3.intranetoas.udistrital.edu.co:8542/v1/",
  //SGA_MID_CALENDARIO_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/sga_mid/v1/',
  //SGA_MID_CALENDARIO_SERVICE: 'http://localhost:8095/v1/',
  SGA_MID_CALENDARIO_SERVICE:
    "http://pruebasapi2.intranetoas.udistrital.edu.co:8545/v1/",
  EVENTO_SERVICE:
    "https://autenticacion.portaloas.udistrital.edu.co/apioas/sesiones_crud/v2/",
